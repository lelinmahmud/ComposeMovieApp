package com.example.composemovieapp.screens.details
    ...
    Scaffold(
        ...
        Surface(modifier = Modifier
            ...
            Column(
                ...
                Divider()
                Text("Movie Images", modifier = Modifier.padding(3.dp))
    ...
    LazyRow() {
        items(newMovieList.first().images) { image ->
            Card(
                ...
                Image(painter = rememberImagePainter(data = image, builder = {
                    crossfade(true)
